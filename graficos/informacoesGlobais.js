...
const porcentagemConectada = ((pessoasConectadas / pessoasNoMundo) * 100).toFixed(2);
    ...
    Cerca de 38% das mais de <span>${pessoasNoMundo}</span> bilhões de pessoas do mundo estão no
...
precisam de transporte, o tempo necessário para isso é de <span>${Math.round((dados.tempo_medio - horas) * 60)}</span> 
